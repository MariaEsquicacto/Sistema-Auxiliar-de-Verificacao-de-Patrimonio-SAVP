...
if ($_SERVER['REQUEST_METHOD'] === 'PATCH') {
    try {
        ...
        // Lógica para criptografar a senha, se ela estiver presente na requisição
        if (isset($data['usuario_senha'])) {
            $senha_em_texto_plano = $data['usuario_senha'];
            $senha_criptografada = hash('sha512', $senha_em_texto_plano);
            $setClauses[] = "usuario_senha = :usuario_senha";
            $params['usuario_senha'] = $senha_criptografada;
        }
